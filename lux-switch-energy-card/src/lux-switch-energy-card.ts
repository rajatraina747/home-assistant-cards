...
export class LuxSwitchEnergyCard extends LitElement {
    ...
    setConfig(config: LuxSwitchEnergyCardConfig) {
        if (!config.entity) {
            throw new Error(localize('common.unavailable'));
        }
        ...
        this._config = {
            ...
            ...config,
            decimals: {
                ...LuxSwitchEnergyCard.getStubConfig().decimals,
                ...config.decimals
            },
            timers: {
                ...LuxSwitchEnergyCard.getStubConfig().timers,
                ...config.timers
            },
            sparkline: {
                ...LuxSwitchEnergyCard.getStubConfig().sparkline,
                ...config.sparkline
            },
            modes: {
                ...LuxSwitchEnergyCard.getStubConfig().modes,
                ...config.modes
            },
            theme: {
                ...LuxSwitchEnergyCard.getStubConfig().theme,
                ...config.theme
            }
        };
